...
```{r Word Freq Plot, echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE}
yelp_words %>% 
...
```{r Rating Over Time, echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE}
yelp_airlines %>%
...
```{r Bing Lexicon, echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE}
...
```{r Guage Bing Sentiment, echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE}
  yelp_bing_sentiment %>%
...
```{r Predicted v Actual, echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE}
...
```{r Capture Area, echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE}
yelp_words %>% 
